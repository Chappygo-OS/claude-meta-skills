...
name: market-funnel
description: >
  Sales funnel analysis and optimization: maps every step, finds leaks, and prioritizes fixes by revenue impact.
---
...
## Phase 0: Customer Journey Layer

Before analyzing the technical funnel, map the **emotional customer journey**. The funnel is what the BUSINESS builds. The customer journey is what the BUYER experiences. They must be aligned.

### The 3 Phases (Mandatory — Cannot Be Skipped or Reversed)

| Phase | Buyer's Mindset | What They Do | What Marketing Must Provide |
|---|---|---|---|
| **1. Awareness (Consciencia)** | "I have a problem and I can't ignore it anymore" | Searches for information, reads articles, watches videos, asks friends. NOT looking for solutions yet — looking for understanding. | Educational content: blog posts, social media, YouTube, SEO content that names and validates their pain. Goal: be found when they search. |
| **2. Consideration (Consideracion)** | "What are my options? Who can help me?" | Compares alternatives (DIY, competitors, different approaches), reads reviews, checks social proof, evaluates pros/cons. | Comparison content, case studies, testimonials, free resources, webinars. Goal: position yourself as the best option. |
| **3. Purchase (Compra)** | "I'm ready to buy — but from whom? And is it worth it?" | Reviews pricing, looks for guarantees, checks objections, needs a final push. | Irresistible offer, risk reversal, urgency/scarcity, clear CTA, frictionless checkout. Goal: remove the last barrier. |

**Critical Rules:**
- Phases are SEQUENTIAL — a buyer in Awareness cannot skip to Purchase
- Phases are IRREVERSIBLE — a buyer in Consideration doesn't go back to Awareness
- Duration varies — some journeys take minutes (impulse buy), others take months (B2B enterprise)
- Your funnel must have content/pages for ALL 3 phases, not just the Purchase phase

### Journey-Funnel Alignment Check

For each funnel step identified in Phase 1, tag which customer journey phase it serves:

```
STEP [#]: [Page Name] → JOURNEY PHASE: [Awareness / Consideration / Purchase]
```

**Common misalignment problems:**
- **No Awareness content** — The site only has product/pricing pages. Buyers in Awareness can't find you.
- **Awareness-to-Purchase jump** — Blog → Buy Now. Missing the Consideration phase (comparisons, case studies, proof).
- **All Consideration, no Purchase trigger** — Great content but no clear offer, no urgency, no CTA.

Flag misalignments in the report as HIGH priority fixes.

### Persona-Journey Matrix (If Buyer Persona Available)

If `MARKETING-AUDIT.md` or `BUYER-PERSONA.md` exists, map how each persona moves through the journey differently:

| Journey Phase | What [Persona 1] Does | What [Persona 2] Does |
|---|---|---|
| Awareness | [How they discover the problem] | [How they discover it] |
| Consideration | [What alternatives they evaluate] | [What alternatives they evaluate] |
| Purchase | [What convinces them to buy] | [What convinces them] |

This matrix reveals whether the funnel serves all personas or only one.
...
[Journey phase mapping for each funnel step:
which phase does each page serve (Awareness/Consideration/Purchase)?
Flag any missing phases or misalignments.]
