...
| [M — Research & Analysis](#template-m--research--analysis) | Research reports, comparisons, deep dives |
| [N — Code Generation](#template-n--code-generation) | General code gen (not tied to a specific file) |
| [O — Data Processing](#template-o--data-processing) | CSV/JSON/table transformation tasks |
| [P — Summarization](#template-p--summarization) | Condensing documents, transcripts, articles |
| [Q — Feedback & Review](#template-q--feedback--review) | Code review, content review, structured critique |
...
## Template M — Research & Analysis

*Use for research reports, competitive comparisons, deep dives, and any task that requires sourcing and synthesizing information before producing output.*
...
## Template N — Code Generation

*Use for general code generation tasks not tied to a specific existing file. For in-file edits use Template G (File-Scope) instead.*
...
## Template O — Data Processing

*Use for CSV/JSON/table/list transformation tasks where the rules are algorithmic and the output format is exact.*
...
## Template P — Summarization

*Use for condensing documents, transcripts, articles, or meeting notes into a structured, actionable output.*
...
## Template Q — Feedback & Review

*Use for code review, content review, design critique, and any structured evaluation task. Works for both technical and non-technical content.*
