...
description: >
  Professional PDF marketing report with score gauges, charts, comparison tables and a prioritized action plan. Uses the bundled generate_pdf_report.py script.
---
