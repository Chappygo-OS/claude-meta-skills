...
name: market-copy
description: >
  Copywriting analysis and optimized rewrites for any page, with concrete before/after examples.
---
...
### 2.4 Buyer Persona Alignment Check

Before generating new copy, check whether the existing copy speaks to the buyer persona's real concerns. If `MARKETING-AUDIT.md` or `BUYER-PERSONA.md` exists, use the persona data. Otherwise, infer from the page itself.

**Score each copy section against persona alignment (0-10):**

| Persona Element | Current Copy Addresses It? | Score |
|---|---|---|
| Pain that triggers search | Does the headline/hero hit the pain point? | X/10 |
| Barriers before buying | Does the page address hesitations? | X/10 |
| Myths / limiting beliefs | Does the copy debunk false assumptions? | X/10 |
| Objections at purchase | Is there FAQ, guarantee, or risk reversal? | X/10 |
| Bad previous experiences | Does the copy differentiate from past failures? | X/10 |
| Power ideas | Does the emotional core resonate throughout? | X/10 |

**Persona Alignment Score: X/60** — A score below 30 means the copy is generic and doesn't connect with the buyer. Generated copy alternatives must address the weakest dimensions.
