...
name: market-landing
description: >
  Landing page CRO analysis: hierarchy, friction, message match and conversion blockers, with prioritized fixes.
---
...
The first screen a visitor sees. This is where 80% of conversion decisions begin. Between 20-35% of visitors leave without scrolling past this section — the hero MUST deliver the value proposition immediately.

**Customer Journey Check:**
Before scoring the hero, identify which journey phase this landing page targets:
- **Awareness page**: Hero should name the pain and offer education ("Is your home stressing you out? Here's why — and what to do about it")
- **Consideration page**: Hero should position against alternatives ("Why 3-visit organization beats weekend DIY every time")
- **Purchase page**: Hero should state the transformation + offer ("Reclaim your calm in 3 visits — limited spots this month")

A mismatch between the traffic source's intent and the hero's message is the #1 conversion killer. Paid social traffic (low intent) landing on a Purchase page = high bounce. Branded search traffic (high intent) landing on an Awareness page = missed conversion.

**Checklist:**
- [ ] Headline is visible within 2 seconds of page load
- [ ] Headline communicates the primary benefit (not a feature)
- [ ] Headline speaks to the buyer persona's pain point (not a generic promise)
